...
class Switcher:
    ...
    @staticmethod
    def _get_replacement_char(
        original_char: str, source_array: str, target_array: str
    ) -> str:
    ...
    @staticmethod
    def _get_replaced_string(
        original_string: str, source_array: str, target_array: str
    ) -> str:
        output = ""
        for original_char in original_string:
            output += Switcher._get_replacement_char(
                original_char, source_array, target_array
            )
        return output
